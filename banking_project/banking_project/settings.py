...
import os #Bug here: 'import os' is needed here because the file fails when it is not present. Note this is a duplicate, the 'import os' is also stated at the start of the file.
STATIC_URL = '/static/'
